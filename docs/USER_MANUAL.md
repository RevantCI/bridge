...
*Written from the app's current state (`v0.8.0-beta.7`, 2026-08-25).*
...
alignment. Every single finding — however Bridge or an AI generated it — is
just a *suggestion for you to review*. You always make the final call
(Accept / Reject / Ignore / Edit).
...
| AI assistance | Not built in | Optional: AI-generated explanations of findings, and AI-proposed word alignments — always your own configured provider/key, always requiring your explicit accept |
...
A focused view for working through translationNotes/translationWords items
for a verse, with the same Accept/Reject/Ignore decisions.
...
- **Quality engine** — a **Basic** vs **Advanced** reviewer-experience mode.
