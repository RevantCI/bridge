...
| A42 | Offline Language QA foundation (#169) | Automatic open/import/edit checks; Tamil characters and detection ambiguity; bounded worker/pages; content-hash reuse; exact bridges/spans; stale-result isolation; pause/recovery/error/limit states; UTF-8-safe diagnostics; separate panel | Source + Frontend + Frozen | PASS — 31 focused engine and 6 panel tests; full engine 1,313 / frontend 480; Svelte 0/0 and production build. Source/frozen 401-verse protocol benchmarks pass. Standard whole-sidecar smoke blocked by pre-existing version mismatch #170. Installed visual acceptance NOT RUN; grammar and other publication gates remain planned in `LANGUAGE_QA_PLAN.md`. |
