...
def main() -> None:
    ...
    # BRIDGE PATCH (see NOTICE.md): %-d/%-H are glibc strftime extensions,
    # not supported by Windows' C runtime — raises ValueError there.
    # Portable equivalent (just always zero-pads single digits, cosmetic
    # only — this is a display timestamp, nothing depends on its format).
