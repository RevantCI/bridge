...
def test_python_and_typescript_controlled_enums_match_canonical_schema() -> None:
    ...
    enum_types = {
        ...
        "MeaningAssessmentReason": MeaningAssessmentReason,
        "MeaningComponentStatus": MeaningComponentStatus,
        "MeaningEvidenceKind": MeaningEvidenceKind,
        "MeaningRunStatus": MeaningRunStatus,
