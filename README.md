...
**Status:** `v0.8.0-beta.12` — the full import → check → review → align →
...
.venv\Scripts\python.exe -m pytest tests/ greek_room_engine/tests/ -v   # expect 259 passed
...
Beta 12 completes Milestone 3B.4. Reviewers can turn a tN/tW finding into a
